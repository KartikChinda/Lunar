...
const Footer = () => {
    return (
        <footer className="group bg-palette-text text-palette-bg border-t-2 pt-4 w-full">
            ...
            <div className="flex justify-center items-center">
                ...
                <h1 className=" group-hover:text-palette-pink font-headings text-white text-6xl md:text-8xl font-bold mt-4 duration-150">
                    WE SELL IT ALL
                </h1>
            </div>
        </footer>
